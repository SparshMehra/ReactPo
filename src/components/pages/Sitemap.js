  ...
  return (
    <div className="p-8 bg-lime-800 dark:bg-darkBlue text-gray-900 dark:text-gray-100 min-h-screen flex flex-col items-center justify-center">
      ...
      <div className="mt-8 text-center text-white dark:text-gray-300">
        ...
        <p>
          Click the "Get Directions" button on any marker to open Google Maps
          with directions to the selected point of interest.
        </p>
        <p className="mt-4">
          You can also click "YOU ARE HERE" to simulate your location on the
          map.
        </p>
      </div>
    </div>
